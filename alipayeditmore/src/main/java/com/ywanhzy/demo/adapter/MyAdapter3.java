...
public class MyAdapter3 extends BaseAdapter implements DragAdapterInterface {
	private List<MenuEntity> datas = new ArrayList<MenuEntity>();
	private Context context;
	private AppContext appContext;

	public MyAdapter3(Context context, AppContext appContext, List<MenuEntity> datas) {
