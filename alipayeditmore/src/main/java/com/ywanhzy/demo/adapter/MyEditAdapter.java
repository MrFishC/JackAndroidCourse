...
public class MyEditAdapter extends BaseAdapter implements DragAdapterInterface {
	private boolean IsEdit = false;
	private List<MenuEntity> datas = new ArrayList<MenuEntity>();
	private EditActivity context;
	private AppContext appContext;

	public MyEditAdapter(EditActivity context, AppContext appContext, List<MenuEntity> datas) {
