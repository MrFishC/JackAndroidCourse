...
//    private TabLayout realTabLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ali_home_more1);
    ...
    private void setOther() {
        ...
        listener = new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                int statusBarH = getStatusBarHeight(StickyActivity1.this);
                int tabH = holderTabLayout.getHeight();

//                int lastH = screenH - statusBarH - tabH + 1 ;                // 1 的作用： very good o

                int lastH = screenH - statusBarH - tabH - dragGridView.getHeight() + 1  ;

                AnchorView anchorView = anchorList.get(anchorList.size() - 1);              //给最后一个AnchorView重新设置params.height的值
...
//        realTabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
        holderTabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            @Override
